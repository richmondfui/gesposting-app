                ...
                <div class="col-md-12">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{route('admin.users.update', $user)}}" class="">
                                @csrf
                                @method('put')
                                <div class="position-relative row form-group"><label for="name"
                                        class="col-sm-2 col-form-label">User Name</label>
                                    <div class="col-sm-10"><input name="name" id="name"
                                            value="{{ old('name', $user->name) }}" placeholder="Nii Amartey" type="text"
                                            class="form-control" required></div>
                                </div>
                                <div class="position-relative row form-group"><label for=""
                                        class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-10"><input name="email" id=""
                                            value="{{ old('email', $user->email) }}" placeholder="admin@admin.com"
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="role_id[]" type="checkbox"
                                                value="{{$role->id}}" @foreach ($user->roles()->pluck('role_id') as
                                            $user_role_id)
                                            {{($role->id == $user_role_id) ? 'checked' : ''}}
                                            @endforeach
                                            >
                                ...
                                <div class="position-relative row form-group"><label for="" class="col-sm-2 col-form-label">District</label>
                                    <div class="col-sm-10">
