                    ...
                    <div class="row">
                        <div class="col-md-12">
                         <div class="main-card mb-3 card">
                              <div class="card-body"><h5 class="card-title">Create District</h5>
                                  <form method="POST" action="{{route('admin.districts.store')}}" class="">
                                   @csrf
                                      <div class="position-relative row form-group"><label for="districtName" class="col-sm-2 col-form-label">District Name</label>
                                          <div class="col-sm-10"><input name="name" id="districtName" placeholder="Gomoa District" type="text" class="form-control" required></div>
                                      </div>
                                        ...
                                        <div class="col-sm-10">
                                            <select name="region_id" id="schoolDistID" class="form-control">
                                                @foreach ($regions as $region)
                                                  <option value="{{$region->id}}">{{ $region->name.' Region' }}</option>
                                                @endforeach
                                            </select>
                                          </div>
                                    </div>
                                      <div class="position-relative row form-group"><label for="districtLocation" class="col-sm-2 col-form-label">Location</label>
                                          <div class="col-sm-10"><input name="location" id="districtLocation" placeholder="" type="text" class="form-control" required></div>
                                      </div>
                                      <div class="position-relative row form-group"><label for="districtDesc" class="col-sm-2 col-form-label">Description</label>
                                          <div class="col-sm-10"><textarea name="description" id="districtDesc" class="form-control"></textarea></div>
                                      </div>
