            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <h5 class="card-title">Update District</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="name" id="districtName" value="{{old('name',$district->name)}}"
                                                placeholder="Gomoa District" type="text" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="position-relative form-group"><label for="schoolDistID"
                                            ...
                                            <select name="region_id" id="schoolDistID" class="form-control">
                                                ...
                                                <option value="{{$region->id}}"
                                                    {{($region->id == $district->region_id) ? 'selected' : ''}}>
                                                    {{ $region->name.' Region' }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="position-relative form-group"><label for="districtLocation"
                                            ...
                                            <input name="location" id="districtLocation" placeholder="Gomoa" type="text"
                                                value="{{old('location',$district->location)}}" class="form-control"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="email" id="districtEmail" placeholder="gomoages@live.com"
                                                type="email" value="{{old('email',$district->email)}}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="position-relative form-group"><label for="districtPhone"
                                            ...
                                            <input name="phone" id="districtPhone" type="text"
                                                value="{{old('phone',$district->phone)}}" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="position-relative form-group"><label for="districtRef"
                                                class="col-form-label">District Ref</label>
                                            <input name="ref" id="districtRef" placeholder="DEO/GD/PF" type="text"
                                                value="{{old('ref',$district->ref)}}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="position-relative form-group"><label for="districtDirector"
                                            ...
                                            <input name="director" id="districtDirector"
                                                value="{{old('director',$district->director)}}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="position-relative form-group"><label for="distAddress"
                                            ...
                                            <textarea name="address" id="distAddress"
                                                class="form-control">{{$district->address}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="position-relative form-group"><label for="districtDesc"
                                            ...
                                            <textarea name="description" id="districtDesc"
                                                class="form-control">{{$district->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
